...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("-r", "--record", action="store_false", help="Record episodes in PlayEnv.")
...
def prepare_wm_env(cfg: DictConfig, args: argparse.Namespace) -> PlayEnv:
    ...
    cfg.env = OmegaConf.load("config/env/robocasa.yaml")
    ...
    assert cfg.env.train.id == "robocasa"
